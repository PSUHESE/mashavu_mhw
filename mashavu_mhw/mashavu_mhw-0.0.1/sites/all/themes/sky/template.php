...
function sky_preprocess_user_login_block(&$vars) {
...
function sky_form_comment_form_alter(&$form, &$form_state) 
//PRE: 
//POST: The comment form is styled to have a single header 'Response' a text box, and a button that says 'Send Feedback'
{
	//Remove the author information 
	unset($form['author']);
	
	//Change the 'Save' Button to say 'Send Feedback'
	$form['actions']['submit']['#value'] = 'Send Feedback';
	
	//Remove the 'Response' title on the Comment form
